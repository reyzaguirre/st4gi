...
spconsis <- function(fb, f = 3, out.mod = c("none", "rcbd", "met"),
  ...
  spc05(fb, "lower", "dmvy", "- Out of range values for dry matter vine yield (dmvy):")
  spc06(fb, f, "low", "dmvy", "- Extreme low values for dry matter vine yield (dmvy):")
  spc06(fb, f, "high", "dmvy", "- Extreme high values for dry matter vine yield (dmvy):")
  ...
  spc05(fb, "lower", "ncrpp", "- Out of range values for number of commercial roots per plant (ncrpp):")
  spc06(fb, f, "low", "ncrpp", "- Extreme low values for number of commercial roots per plant (ncrpp):")
  spc06(fb, f, "high", "ncrpp", "- Extreme high values for number of commercial roots per plant (ncrpp):")
  ...
  if (oc == 1) {
    ...
    spc07(fb, geno, env, rep, "dmvy", out.mod, out.max, "- Outliers for dry matter vine yield (dmvy):")
    ...
    spc07(fb, geno, env, rep, "ncrpp", out.mod, out.max, "- Outliers for number of commercial roots per plant (ncrpp):")
