...
#' \item \code{$Pesek.Baker.Index}, a data frame with the genotypic means for each variable,
...
pesekbaker <- function(geno, vars, dgg = NULL, units = c("sdu", "actual"),
  ...
  # Standard deviations for variables
