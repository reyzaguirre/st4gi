...
check.data.pt <- function(dfr, f, out.mod, out.max, add) {
  ...
  # Inconsistencies for npe and dependencies (plant_unif, plant_vigor, pw_ev.i)
  ...
  for(i in 1:5){
    ...
    sp5(dfr, f,  "low", xtemp, paste0("- Extreme low values for increase stem number per plant ", i, " (", xtemp, "):"))
    sp5(dfr, f, "high", xtemp, paste0("- Extreme high values for increase stem number per plant ", i, " (", xtemp, "):"))
    xtemp <- paste0('insd', i)
    sp5(dfr, f,  "low", xtemp, paste0("- Extreme low values for increase stem diameter ", i, " (", xtemp, "):"))
    sp5(dfr, f, "high", xtemp, paste0("- Extreme high values for increase stem diameter ", i, " (", xtemp, "):"))
    xtemp <- paste0('inrwc', i)
    sp5(dfr, f,  "low", xtemp, paste0("- Extreme low values for increase relative water content ", i, " (", xtemp, "):"))
    sp5(dfr, f, "high", xtemp, paste0("- Extreme high values for increase relative water content ", i, " (", xtemp, "):"))
    xtemp <- paste0('inplahe', i)
    sp5(dfr, f,  "low", xtemp, paste0("- Extreme low values for increase plant height ", i, " (", xtemp, "):"))
    sp5(dfr, f, "high", xtemp, paste0("- Extreme high values for increase plant height ", i, " (", xtemp, "):"))
    xtemp <- paste0('snpp', i)
    ...
    xtemp <- paste0('chc', i)
    sp5(dfr, f,  "low", xtemp, paste0("- Extremelow values for chlorophyll content sample ", i, " (", xtemp, "):"))
    sp5(dfr, f, "high", xtemp, paste0("- Extreme high values for chlorophyll content sample ", i, " (", xtemp, "):"))
    xtemp <- paste0('inchc', i)
    sp5(dfr, f,  "low", xtemp, paste0("- Extremelow values for increase chlorophyll content ", i, " (", xtemp, "):"))
    sp5(dfr, f, "high", xtemp, paste0("- Extreme high values for increase chlorophyll content ", i, " (", xtemp, "):"))
    xtemp <- paste0('leafsd', i)
    sp5(dfr, f,  "low", xtemp, paste0("- Extreme low values for leaf stomata density sample ", i, " (", xtemp, "):"))
    sp5(dfr, f, "high", xtemp, paste0("- Extreme high values for leaf stomata density sample ", i, " (", xtemp, "):"))
