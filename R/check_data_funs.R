...
check.data.sp <- function(dfr, f, out.mod, out.max, add) {
  ...
  sp5(dfr, f, "high", "ancrw", "- Extreme high values for average non commercial root weight (ancrw):", 0.175)
  ...
  sp5(dfr, f, "high", "atrw", "- Extreme high values for average total root weight (atrw):", 0.75)
