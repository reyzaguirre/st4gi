...
rules.sp0 <- function(dfr, f, out.mod, out.max, add, format) {
...
rules.pt0 <- function(dfr, f, out.mod, out.max, add, format) {
  ...
  dfr.out <- rbind(dfr.out, sp4(dfr, "lower", "aal_fw", "- Out of range values for tuber lipophilic antioxidant activity in fresh weight basis (aal_fw):", format = format))
  ...
  dfr.out <- rbind(dfr.out, sp5(dfr, f, "low",  "aal_fw", "- Extreme low values for tuber lipophilic antioxidant activity in fresh weight basis (aal_fw):", format = format))
